...
<body>
    ...
    <section class="about-us">
        <div class="container mt-5">
            ...
            <p>Welcome to AutoReceipt, a cutting-edge system designed to streamline and automate receipt management for businesses and educational institutions. Our platform offers a comprehensive suite of features to manage, generate, and track receipts with ease.</p>
            ...
            <ul>
                ...
                <li><strong>Data Management:</strong> Store and manage receipt data securely with easy retrieval options.</li>
            ...
            <p>If you have any questions or need assistance, feel free to reach out to us through our <a href="contact.php">contact page</a>. We are here to help and look forward to hearing from you!</p>
        </div>
    </section>
    <!-- About Us Section -->
